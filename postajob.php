<?php
    ...
    if(isset($_POST["submit"])){
        $sql="INSERT INTO postedjobs(id, usn,companyname, job, jobdescription,salary,skills,timeposted) values (Null,'$usn','$companyname','$job','$jobdescription','$salary','$skills',NOW())";
        ...
        <div class="formcontainer">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" name="mentorform" method="post">
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter your USN" name="usn" autocomplete="off" required>
                    </div>
                    <div class="input-box">
