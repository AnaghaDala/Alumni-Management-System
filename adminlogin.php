<?php
  ...
  $message=$password="";
  if(count($_POST)>0){
    $result= mysqli_query($con, "SELECT * FROM adminlogin WHERE username='".$_POST["username"]."' and department='".$_POST["department"]."' and password='".$_POST["password"]."'");
    if(!$result){
...
<html lang="en">
  ...
  <body>
    <div class="main">
      <div class="bg-img">
        <div class="bg"><img src="./assets/images/login-img.webp" alt="img" width="100%" height="150%"></div>
          ...
          <input type="text" name="department" placeholder="Enter your department" autocomplete="off" required><br><br>
